...
export default defineConfig({
  ...
  themeConfig: {
    nav: [
      { text: '首页', link: '/' },
      { text: '充电学习', link: '/markdown-examples' },
      { text: 'Me', link: '/markdown-examples' }
    ],
